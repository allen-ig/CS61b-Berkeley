...
public class SList {
    ...
    public static void main (String[] args) {
        ...
        SListNode l2 = new SListNode(9);
        SListNode l3 = new SListNode(12);
        l1.next = l2;
        l2.next = l3;
        list1.head = l1;
        list1.tail = l3;
        System.out.println("answer begins here **********************************");
        System.out.println("list1 should be [6 9 12]:" + list1);
        list1.insertFront(3);
        list1.insertEnd(15);
        System.out.println("list1 should be [3 6 9 12 15]:" + list1);
